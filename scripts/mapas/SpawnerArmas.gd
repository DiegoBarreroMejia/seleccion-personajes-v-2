...
# Configura temporizador y genera arma inicial si corresponde
func _ready() -> void:
...
# Crea el temporizador de respawn
...
# Genera un arma aleatoria del pool
...
# Desconecta senal e inicia cooldown al recoger el arma
...
# Genera nueva arma al terminar el cooldown
...
# Elimina arma actual y genera una nueva inmediatamente
...
# Elimina el arma actual sin generar nueva
...
# Devuelve si hay un arma en el spawner
